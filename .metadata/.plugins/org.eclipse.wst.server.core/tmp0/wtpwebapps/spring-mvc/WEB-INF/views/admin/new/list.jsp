...
<body>
								...
								<div class="table-btn-controls">
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											<c:url var="createNewURL" value="/quan-tri/bai-viet/chinh-sua"/> <!-- Nút thêm mới bài viết -->
											<a flag="info"
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="table-responsive">
										...
										<!-- Hàm "pagination" được tại ở đoạn script bên dưới. Sử dụng phân trang trên web: https://www.jqueryscript.net/other/Simple-Customizable-Pagination-Plugin-with-jQuery-Bootstrap-Twbs-Pagination.html -->
	...
	<script type="text/javascript">
		...
		function deleteNew(data) {//Call api để thực hiện xóa
	        $.ajax({
	            url: '${newAPI}',
	            type: 'DELETE',
